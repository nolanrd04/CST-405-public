...
%token <num> TRUE FALSE /* Boolean tokens carry integer values (0 or 1) */
%token BOOL
%token AND OR NOT
...
%left AND OR /* Logical operators precedence */
%right NOT /* NOT has right associativity */
...
expr:
    ...
    | TRUE {
        ...
        $$ = createNum(1, 0);  /* True as integer 1 */
    }
    | FALSE {
        /* Boolean literal false */
        $$ = createNum(0, 0);  /* False as integer 0 */
    }
    | expr AND expr {
